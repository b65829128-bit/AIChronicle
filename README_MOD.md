...
- **攻城后定归属**：AI 攻下的城镇/城堡不再触发原版影响力投票，改由国王 Agent 决定（P1 级激活，与外交提案同级），用 `gift_fief` 赐予合适家族；玩家亲自攻下的城保留原版菜单。开关：MCM「册封由 Agent 主导」
...
| 册封由 Agent 主导 | AI 攻下的城不再触发原版影响力投票，改由国王 Agent 决定归属（玩家亲自攻下的城保留原版菜单） | 开启 |
